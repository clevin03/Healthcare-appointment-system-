...
if ($doctor_id > 0) {
    ...
    $sql_pending_appointments = "SELECT COUNT(*) AS total FROM appointments a LEFT JOIN sessions s ON a.session_id = s.session_id WHERE a.doctor_id = ? AND a.status = 'CONFIRMED' AND s.session_day >= CURDATE()";
